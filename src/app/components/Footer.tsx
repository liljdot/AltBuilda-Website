...
const Footer: React.FC = () => {
    ...
    return (
        <>
            <footer className="footer footer-horizontal footer-center relative bg-[#161616] text-base-content py-0 px-34 z-100 before:absolute before:-translate-y-[50%] before:h-[66%] before:w-[120%] before:bg-[#161616] before:rounded-t-[50%] before:-z-1">
                {/* footer start  */}
